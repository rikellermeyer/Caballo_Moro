...
candid_df.to_csv(f'{data_path}/CA_trend.filtered.fixedBP.tsv', index = False)
...
"""
# capture SNPs and p-values of 5 candidate genes
specific_genes = trendsnps_to_gene_df.loc[trendsnps_to_gene_df['gene_id'].isin(['gja8b', 'apcdd1l', 'agrn', 'tubgcp3','rpgrip1'])]
specific_genes = specific_genes[['CHR', 'SNP', 'A1', 'A2', 'P', 'gene_id']]
specific_genes.to_csv(f'{data_path}/specific_genes_GWAS_output.txt', index = False)
"""
